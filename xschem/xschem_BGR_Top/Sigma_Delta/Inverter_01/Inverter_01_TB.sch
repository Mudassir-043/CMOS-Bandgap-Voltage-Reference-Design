...
C {Sigma_Delta/Inverter_01/Inverter_01.sym} 110 -50 0 0 {name=X1}
C {devices/code_shown.sym} -75 -230 0 0 {name=s3 only_toplevel=false value="
.control
*plot -i(V2)
plot v(VOUT)
*plot v(VOUTP)
...
C {devices/gnd.sym} 240 -10 0 0 {name=l11 lab=GND}

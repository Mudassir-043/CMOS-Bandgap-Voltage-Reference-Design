...
C {devices/vsource.sym} 510 -830 0 0 {name=V1 value="1.5 AC 1m"}
C {devices/gnd.sym} 510 -780 0 0 {name=l18 lab=GND}
C {devices/lab_wire.sym} 510 -880 0 0 {name=l19 sig_type=std_logic lab=VIP}
C {devices/vsource.sym} 640 -830 0 0 {name=V2 value="1.5 AC 1m 180"}
...
C {Sigma_Delta/Op_Amp/OpampM.sym} 910 -910 0 0 {name=XOpampM1}

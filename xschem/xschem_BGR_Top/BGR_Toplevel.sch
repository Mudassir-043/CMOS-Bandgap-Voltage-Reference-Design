...
C {devices/lab_wire.sym} 410 -1180 0 1 {name=l1 sig_type=std_logic lab=V_first}
C {devices/lab_wire.sym} 520 -1260 0 0 {name=l2 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 540 -1260 0 1 {name=l3 sig_type=std_logic lab=IBIAS2}
C {devices/lab_wire.sym} 520 -1110 2 0 {name=l4 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 660 -1190 0 1 {name=l5 sig_type=std_logic lab=VBGR1}
C {devices/iopin.sym} -320 -1360 0 0 {name=p7 lab=IBIAS2}
C {Opamp_Jaffar_withBlocks.sym} 510 -1190 0 0 {name=x1}
